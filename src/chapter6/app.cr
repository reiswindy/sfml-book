...
module SfmlBook::Chapter6
  class Application
    ...
    def initialize
      ...
      @window = SF::RenderWindow.new(mode, "SFML Application - Chapter 6")
      ...
      @textures.load(Textures::ButtonNormal , "media/textures/button_normal.png")
      @textures.load(Textures::ButtonPressed , "media/textures/button_pressed.png")
      @textures.load(Textures::ButtonSelected , "media/textures/button_selected.png")
    ...
    def register_states
      ...
      @state_stack.register(SettingsState, States::Settings)
    end
...
app = SfmlBook::Chapter6::Application.new
app.run
